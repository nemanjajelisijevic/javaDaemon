...
public interface ImageMoverM {
    ...
    @CallingThread
    <K extends ImageMoverM> K setBorders(float x, float y);

    @SideQuest(SLEEP = 25)
    PositionedBitmap move();

    PositionedBitmap explode(Closure<PositionedBitmap> update) throws InterruptedException;
